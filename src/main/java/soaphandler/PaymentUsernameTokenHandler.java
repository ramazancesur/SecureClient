 ...
 */
@Stateless
public class PaymentUsernameTokenHandler implements SOAPHandler<SOAPMessageContext> {


    private String username="nkolay";

    private String password="nkolay1";

    public PaymentUsernameTokenHandler() {
    }
